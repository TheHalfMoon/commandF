...
anchor = 'const CF06_WORKFLOW_BLOB: &str = "664e303983d2ef85aad934cbef2c14d63744e0ee";\n'
addition = (
...
anchor = "fn github_api_bytes(url: &str) -> Vec<u8> {\n"
helper = r'''fn canonical_ruleset_view(url: &str, ruleset_id: u64) -> Value {
...
'''
new = '''    let assurance = canonical_ruleset_view(
