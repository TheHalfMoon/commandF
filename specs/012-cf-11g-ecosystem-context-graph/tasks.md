...
- [ ] T010 — Introduce explicit lock schema v2 model and version-aware decoding.
...
- [ ] T011 — Capture exact parent→child dependency edges during resolver traversal.
...
- [ ] T012 — Prove lock v2 determinism and v1 compatibility.
...
- [ ] T020 — Add library-owned Context Graph schema v1.
...
- [ ] T021 — Build artifact nodes through the existing bounded CF-02 inspection boundary.
...
- [ ] T022 — Implement StructureDefinition V1 reference extraction.
...
- [ ] T023 — Implement ValueSet and CodeSystem V1 reference extraction.
  - ValueSet include/exclude `system` and imported `valueSet[]`;
  - CodeSystem `supplements`.

- [ ] T024 — Implement deterministic in-closure canonical target resolution.
...
- [ ] T025 — Expose explicit extraction coverage.
...
- [ ] T026 — Prove Context Graph byte determinism and graph invariants.
...
- [ ] T030 — Add `commandf context` CLI command.
  - `--lock` path.
  - `--cache` path.
...
- [ ] T031 — Enforce lock/cache fail-closed behavior at CLI boundary.
...
- [ ] T032 — Add end-to-end graph fixtures.
...
- [ ] T033 — Add exact-head deterministic CLI proof.
