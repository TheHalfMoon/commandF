...
- [x] **T011 — Final review/convergence.** Convergence is recorded. Exact convergence head `e544523e46ae43901faad4fec78258ebfeaf99fe` passed run `31755709606` (Format, Clippy `--locked`, Test `--locked`, real registry + inspect smoke). CodeRabbit was requested but rate-limited; Qodo returned no review evidence. PR remains Draft and CF-03 behavior is not introduced.
